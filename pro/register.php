            ...
            <div class="row">
                ...
                <div class="col-sm-9 col-md-8 col-lg-4 col-xl-4">
                    <div class="input-group">
                        ...
                        <!--  THIS EXPRESSION IS FOR MONTH NUMBER [0-9]|[0][1-9]|[1][0-2] -->
                        <!--  THIS EXPRESSION IS FOR YEAR [1][9][5-9][0-9]|[2][0][0][0-1] -->
                        <!-- THIS EXPRESSION IS FOR MONTH DATE 0[1-9]|[1-2][0-9]|[3][0-1]  -->
                    </div>
                </div>
                <div class="d-none d-sm-block col-sm-3 col-md-4 col-lg-2 col-xl-2 mt-auto">
